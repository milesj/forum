...
<?php } else {
	...
	echo $this->Form->input('level', array('options' => $this->Common->options(4), 'label' => __d('forum', 'Access Level', true), 'empty' => false));
	echo $this->Form->input('is_super', array('options' => $this->Common->options(1), 'label' => __d('forum', 'Is Super Moderator?', true), 'empty' => false));
	echo $this->Form->input('is_admin', array('options' => $this->Common->options(1), 'label' => __d('forum', 'Is Administrator?', true), 'empty' => false));
