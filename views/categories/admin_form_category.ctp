...
echo $this->Form->input('accessRead', array('options' => $this->Forum->options(4, null, true), 'label' => __d('forum', 'Read Access', true)));
echo $this->Form->input('accessPost', array('options' => $this->Forum->options(4), 'label' => __d('forum', 'Post Access', true)));
echo $this->Form->input('accessReply', array('options' => $this->Forum->options(4), 'label' => __d('forum', 'Reply Access', true)));
echo $this->Form->input('accessPoll', array('options' => $this->Forum->options(4), 'label' => __d('forum', 'Poll Access', true)));
echo $this->Form->input('settingPostCount', array('options' => $this->Forum->options(), 'label' => __d('forum', 'Increase Users Post/Topic Count', true)));
echo $this->Form->input('settingAutoLock', array('options' => $this->Forum->options(), 'label' => __d('forum', 'Auto-Lock Inactive Topics', true)));
