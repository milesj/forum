...
<div class="forumWrap" id="forum_<?php echo $forum['Forum']['id']; ?>">
	<h3>
        ...
        <span class="gray">(<?php echo $this->Cupcake->options(3, $forum['Forum']['status']); ?>)</span>
    </h3>
    ...
    <tr id="category_<?php echo $category['id']; ?>">
        ...
        <td class="ac"><?php echo $this->Cupcake->options(2, $category['status']); ?></td>
        <td class="ac"><?php echo number_format($category['topic_count']); ?></td>
        <td class="ac"><?php echo number_format($category['post_count']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $category['accessRead'], true); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $category['accessPost']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $category['accessReply']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $category['accessPoll']); ?></td>
        <td class="ac gray">
 	...
 	<tr id="category_<?php echo $child['id']; ?>" class="altRow">
        ...
        <td class="ac"><?php echo $this->Cupcake->options(2, $child['status']); ?></td>
        <td class="ac"><?php echo number_format($child['topic_count']); ?></td>
        <td class="ac"><?php echo number_format($child['post_count']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $child['accessRead'], true); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $child['accessPost']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $child['accessReply']); ?></td>
        <td class="ac"><?php echo $this->Cupcake->options(4, $child['accessPoll']); ?></td>
        <td class="ac gray">
