...
class StaffController extends ForumAppController {
	...
	public function admin_index() {
		$this->ForumToolbar->pageTitle(__d('forum', 'Staff', true));
	...
	public function admin_add_access() {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Add Access', true));
		$this->set('method', 'add');
	...
	public function admin_edit_access($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Edit Access', true));
	...
	public function admin_add_access_level() {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Add Access Level', true));
		$this->set('method', 'add');
	...
	public function admin_edit_access_level($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Edit Access Level', true));
		$this->set('method', 'edit');
		$this->render('admin_form_access_level');
	}
	...
	public function admin_delete_access_level($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Delete Access Level', true));
	...
	public function admin_add_moderator() {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Add Moderator', true));
		$this->set('method', 'add');
	...
	public function admin_edit_moderator($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Edit Moderator', true));
		$this->set('method', 'edit');
		$this->set('forums', $this->Forum->getGroupedHierarchy('accessRead'));
		$this->render('admin_form_moderator');
	}
