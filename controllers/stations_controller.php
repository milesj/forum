...
class StationsController extends ForumAppController {
	...
	public function moderate($slug) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Moderate', true), $forum['Forum']['title']);
		$this->set('forum', $forum);
		$this->set('topics', $this->paginate('Topic'));
	...
	public function admin_index() {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Manage Forums', true));
	...
	public function admin_add() {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Add Forum', true));
		$this->set('method', 'add');
	...
	public function admin_edit($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Edit Forum', true), $forum['Forum']['title']);
	...
	public function admin_delete($id) {
		...
		$this->ForumToolbar->pageTitle(__d('forum', 'Delete Forum', true), $forum['Forum']['title']);
		$this->set('forum', $forum);
		$this->set('levels', $this->Forum->AccessLevel->getHigherLevels());
