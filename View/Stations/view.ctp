		...
		<table class="table">
			<tbody>
				<tr>
					...
					<td><strong><?php echo $this->Forum->hasAccess($forum['Forum']['accessRead']) ? __d('forum', 'Yes') : __d('forum', 'No'); ?></strong></td>

					<td class="align-right"><?php echo __d('forum', 'Can Create Topics'); ?>: </td>
					<td><strong><?php echo $this->Forum->hasAccess($forum['Forum']['accessPost']) ? __d('forum', 'Yes') : __d('forum', 'No'); ?></strong></td>
				</tr>
				<tr>
					...
					<td><strong><?php echo $this->Forum->hasAccess($forum['Forum']['accessReply']) ? __d('forum', 'Yes') : __d('forum', 'No'); ?></strong></td>

					<td class="align-right"><?php echo __d('forum', 'Can Create Polls'); ?>: </td>
					<td><strong><?php echo $this->Forum->hasAccess($forum['Forum']['accessPoll']) ? __d('forum', 'Yes') : __d('forum', 'No'); ?></strong></td>
				</tr>
				<?php if ($moderators) { ?>
					<tr>
